...
<head>
    ...
    <title>Welcome to Food Donate</title>
    ...
    <style>
        * {
        ...
        body {
            /* Full-screen food mosaic background overlay to tie into the ecosystem */
        ...
        /* Frosted Glassmorphism Gateway Card */
        .portal-card {
        ...
        /* Glowing Eco Seedling Logo Badge */
        .logo-badge {
        ...
        .btn-user:hover {
            ...
            box-shadow: 0 8px 22px rgba(46, 213, 115, 0.55);
        }

        /* Admin Portal Node Button (Charcoal) */
        .btn-admin {
        ...
        .btn-admin:hover {
            ...
            box-shadow: 0 8px 22px rgba(47, 53, 66, 0.55);
        }

        /* Delivery Personnel Node Button (Orange/Coral) */
        .btn-delivery {
        ...
        .btn-delivery:hover {
            transform: translateY(-3px);
            box-shadow: 0 8px 22px rgba(255, 159, 67, 0.55);
        }
...
<body>
    ...
    <div class="portal-card">
        ...
        <p class="para">Identify your portal access node</p>
        ...
        <div class="button-container">
            ...
            <a href="delivery/deliverylogin.php" class="btn-delivery">
                <i class="fa-solid fa-motorcycle"></i> Delivery Personnel
            </a>
        </div>

        <div class="footer-note">
            &copy; 2026 Food Waste Management System Ecosystem
        </div>
    </div>
